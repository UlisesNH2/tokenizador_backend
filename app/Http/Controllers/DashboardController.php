...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        LN_COMER, LN_TERM, FIID_TARJ, LN_TARJ, sum(MONTO1) AS MONTO, count(*) as TXS, FECHA_TRANS, HORA_TRANS from ".$request -> bd." group by KQ2_ID_MEDIO_ACCESO, CODIGO_RESPUESTA, ENTRY_MODE, ID_COMER, TERM_COMER, FIID_COMER, FIID_TERM,
        ...
        LN_COMER, LN_TERM, FIID_TARJ, LN_TARJ, sum(MONTO1) AS MONTO, count(*) as TXS, FECHA_TRANS, HORA_TRANS from ".$request -> bd." group by KQ2_ID_MEDIO_ACCESO, 
